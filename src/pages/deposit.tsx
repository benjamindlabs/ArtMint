          ...
          <div className="max-w-2xl mx-auto">
            ...
            {showConfirmation ? (
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-8">
                ...
                <h2 className="text-xl font-semibold text-center mb-2">Transaction Initiated</h2>
                <p className="text-gray-600 dark:text-gray-400 text-center mb-6">
                  Your deposit of {amount} ETH has been initiated. Please wait for the blockchain confirmation.
                </p>
              ...
              <>
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-8">
                  ...
                  <h2 className="text-xl font-semibold mb-4">Your Deposit Address</h2>
                  <div className="bg-gray-100 dark:bg-gray-900 p-4 rounded-lg flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-yellow-700 dark:text-yellow-500 text-sm">
                          Send only {network === 'ethereum' ? 'ETH' : 'MATIC'} to this deposit address. Sending any other token may result in permanent loss.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full">
                      ...
                      <tbody>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-4 text-sm">Apr 2, 2025</td>
                        ...
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <td className="py-4 text-sm">Mar 28, 2025</td>
                        ...
                        <tr>
                          <td className="py-4 text-sm">Mar 15, 2025</td>
                          <td className="py-4 text-sm">0.8 ETH</td>
                          <td className="py-4">
                            <span className="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                              Confirmed
                            </span>
